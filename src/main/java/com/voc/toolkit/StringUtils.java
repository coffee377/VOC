...
public class StringUtils {
    ...
    public static String sqlArgsFill(String content, Object... args) {
        if (com.baomidou.mybatisplus.toolkit.StringUtils.isEmpty(content)) {
            return null;
        }
        if (args != null) {
    ...
    public static String sqlParam(Object obj) {
        ...
        if (obj instanceof Collection) {
            repStr = com.baomidou.mybatisplus.toolkit.StringUtils.quotaMarkList((Collection<?>) obj);
        } else {
            repStr = com.baomidou.mybatisplus.toolkit.StringUtils.quotaMark(obj);
        }
        return repStr;
    }
    ...
    public static String quotaMarkList(Collection<?> coll) {
        ...
        while (iterator.hasNext()) {
            String tempVal = com.baomidou.mybatisplus.toolkit.StringUtils.quotaMark(iterator.next());
